package com.warrior.ddamddam.user.service;
...
import com.warrior.ddamddam.user.repository.UserRepository;
import com.warrior.ddamddam.user.security.UserDetailsImpl;
import com.warrior.ddamddam.user.security.kakao.KakaoOAuth2;
...
public class UserService {
    ...
    @Autowired
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, KakaoOAuth2 kakaoOAuth2, NaverOAuth2 naverOAuth2, AuthenticationManager authenticationManager) {
    ...
    public void kakaoLogin(String authorizedCode) {
        ...
        User kakaoUser = userRepository.findByApiId(kakaoId)
                .orElse(null);
    ...
    public void naverLogin(String authorizedCode) {
        // 카카오 OAuth2 를 통해 카카오 사용자 정보 조회
        ...
        // DB 에 중복된 Kakao Id 가 있는지 확인
        User naverUser = userRepository.findByApiId(naverId)
                .orElse(null);
        ...
        if (naverUser == null) {
            ...
            if (sameEmailUser != null) {
                ...
                naverUser = new User(username, encodedPassword, email, role, naverId);
                userRepository.save(naverUser);
            }
        }
